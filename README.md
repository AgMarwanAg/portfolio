...
- HTML5
- CSS3 (with modern features like backdrop-filter, clip-path, and CSS variables)
- Vanilla JavaScript
...
This portfolio uses modern CSS features like `backdrop-filter` which may not be supported in all browsers. For best results, use the latest versions of:
